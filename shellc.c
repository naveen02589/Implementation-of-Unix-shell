...
void openhelp()
{
printf("Developed by jai and naveen\n");
printf("Most of the basic unix commands are implemented\n");
printf("use man pages for further reference\n");
...
void bang_execute()
{
 ...
 char *tokenise_bang[100], *num_ch[10];
  ...
  if(strlen(input_buffer) == 1)
	return; // this is to avoid seg_fault
 //printf("%d\n", no_of_lines);
  if(input_buffer[i]=='!')
        {
